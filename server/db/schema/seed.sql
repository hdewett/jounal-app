...
VALUES
  ...
  ('Learning to Program', '2022-02-01', '<p>If you are just learning how to <strong>program,&nbsp;</strong>then you should definitely read this entire article.</p>
  ...
  ('How do promises work??', '2022-02-02', '<p>Promises work like magic. And im actually still dont fully understand how they work...</p>
  ...
  ('Asynchronous Programming for Beginners', '2022-02-03', '<p>What the heck is <strong>asynchronous programming</strong> and how does it work!?</p>
  ...
  ('Practice with ternary operators', '2022-02-03', '<p>The&nbsp;<strong>conditional (ternary) operator</strong>&nbsp;is
  ...
  ('Object Destructuring: The eighth wonder of the world', '2022-02-04', '<h1>Destructuring assignment</h1>
  ...
  ('Getting to know CSS', '2022-02-01', '<h1>CSS: Cascading Style Sheets</h1>
    <div class="section-content">
    ...
    .tiny-mce {
      ...
      ('The basics of HTML', '2022-02-02', '<h1>HTML: HyperText Markup Language</h1>
<div class="section-content">
...
('How do you use .filter in JS?', '2022-02-7', '<h1>Array.prototype.filter()</h1>
<div class="section-content">
...
('How to create classes in Python?', '2022-02-08', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    ...
    ('How do I use power functions in Java?', '2022-02-08', '<p>How do I use power functions in Java?</p>
    ...
    ('How to set up a workspace in PyCharm', '2022-02-10', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('What is `this` Keyword in JavaScript? Here`s How to Implement It', '2022-02-02', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('How to Set Up Unit Testing for Java', '2022-02-01', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('What is Cypress testing?', '2022-02-02', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('Alternative Methods to Using Nested For Loops in Javascript', '2022-02-10', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('What is PostgreSQL?', '2022-02-13', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('How to Avoid Infinite Loops in Javascript: Understanding Comparison Operators', '2022-02-14', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
    ...
    ('Using HTTP Methods for RESTful Services', '2022-02-15', '<p>Python uses an <u>init</u> constructor to set up classes!</p>
    <p>&nbsp;</p>
    <pre class="language-python"><code>class Person:
      def init(self, name, age):
        self.name = name
